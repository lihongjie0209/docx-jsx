...
export default <Document defaultCharacterSpacing={0.5} createdAt="2026-08-14T00:00:00Z" updatedAt="2026-08-15T00:00:00Z" customProperties={{Project: "Apollo"}} documentId="01234567-89AB-CDEF-0123-456789ABCDEF" defaultTabStop={36} documentVariables={{Customer: "Ada"}} evenAndOddHeaders adjustLineHeightInTable characterSpacingControl="compressPunctuation" styles={[{id: "ReportTitle", name: "Report Title", type: "paragraph", basedOn: "Normal", quickFormat: true, run: {font: "Noto Sans CJK SC", size: 18, color: "336699", bold: true}, paragraph: {align: "center", spacingAfter: 12, outlineLevel: 1}}]}><Section titlePage textDirection="tbRl" documentGrid={{type: "linesAndChars", linePitch: 18, charSpace: -10}} pageNumbering={{start: 3, chapterStyle: "1"}}>
