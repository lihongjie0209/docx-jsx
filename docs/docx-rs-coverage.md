...
| Table | width, alignment, layout, grid, borders, style, indentation, cell margins | floating position |
| TableRow | height/rule, cant-split | before/after grid widths (upstream serializer currently drops them), revisions |
